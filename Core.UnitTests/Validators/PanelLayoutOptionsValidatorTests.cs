...
public class PanelLayoutOptionsValidatorTests
{
    ...
    {
        var options = new PanelLayout(DefaultLength, DefaultHeight, DefaultPanelWidth, DefaultSidePanelWidth, DefaultOffset);
    ...
    {
        var options = new PanelLayout(length, DefaultHeight, DefaultPanelWidth, DefaultSidePanelWidth, DefaultOffset);
    ...
    {
        var options = new PanelLayout(DefaultLength, height, DefaultPanelWidth, DefaultSidePanelWidth, DefaultOffset);
    ...
    {
        var options = new PanelLayout(DefaultLength, DefaultHeight, panelWidth, DefaultSidePanelWidth, DefaultOffset);
    ...
    {
        var options = new PanelLayout(DefaultLength, DefaultHeight, DefaultPanelWidth, sidePanelWidth, DefaultOffset);
    ...
    {
        var options = new PanelLayout(DefaultLength, DefaultHeight, DefaultPanelWidth, DefaultSidePanelWidth, -0.1);
    ...
    {
        var options = new PanelLayout(DefaultLength, DefaultHeight, DefaultPanelWidth, DefaultSidePanelWidth, targetOffset);
    ...
    {
        var options = new PanelLayout(length: 10, height: 5, panelWidth: 3, sidePanelWidth: 1, targetOffset: 0.3);
    ...
    {
        var options = new PanelLayout(length: 0, height: -5, panelWidth: 1, sidePanelWidth: 1, targetOffset: 0.3);
